...
public class LevelParser : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Have a thing that moves the tile offset on the question box by one every second.
        if(questionTimer >= 1)
        {
            //For loop to grab all the prefabs with the tag question under the levelroot
            //Get their material;
            //Increase the tile by 1.
            //Reset the timer by 1
            questionTimer = 0;
        }
    }
